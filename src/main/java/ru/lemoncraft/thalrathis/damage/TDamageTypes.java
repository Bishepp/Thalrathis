package ru.lemoncraft.thalrathis.damage;
...
public class TDamageTypes {
    ...
    public static void bootstrap(BootstapContext<DamageType> context) {
        context.register(AIR_MAGIC, new DamageType(AIR_MAGIC.location().getPath(), DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0f));
