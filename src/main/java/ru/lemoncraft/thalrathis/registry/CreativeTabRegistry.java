...
public class CreativeTabRegistry {
    ...
    public static final RegistryObject<CreativeModeTab> EQUIPMENT_TAB = TABS.register("equipment_item", () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, entries) -> {
                ...
                entries.accept(ItemRegistry.CHIBI_BISHEPP_ITEM.get());
                entries.accept(ItemRegistry.CHIBI_MRKILLERS_ITEM.get());
                entries.accept(ItemRegistry.CHIBI_LEMON_ITEM.get());
            })
